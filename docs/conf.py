...
htmlhelp_basename = 'pinetree_doc'
...
latex_documents = [
    (master_doc, 'pinetree.tex', 'Pinetree Documentation',
...
man_pages = [
    (master_doc, 'pinetree', 'Pinetree Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pinetree', 'Python/C++ Project Example Documentation',
     author, 'pinetree', 'One line description of project.',
     'Miscellaneous'),
]
