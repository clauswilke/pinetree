...
htmlhelp_basename = 'pysinthe_doc'
...
latex_documents = [
    (master_doc, 'pysinthe.tex', 'Python/C++ Project Example Documentation',
...
man_pages = [
    (master_doc, 'pysinthe', 'Pysinthe Simulation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pysinthe', 'Python/C++ Project Example Documentation',
     author, 'pysinthe', 'One line description of project.',
     'Miscellaneous'),
]
