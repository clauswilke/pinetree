...
Although Pinetree is a stochastic simulation, it was implemented in Python with a C++ back-end and designed to be highly efficient. On a desktop-class CPU, simulating gene expression in a 40 kilobase viral genome for 20 minutes takes about 3 hours in computation time.
